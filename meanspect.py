...
def main(folder_path, output_csv):
    ...
    # Get the sampling rate from the first audio file
    ...
    np.savetxt(output_csv, average_spectrogram, delimiter=',')  # Save average spectrogram to CSV
...
if __name__ == "__main__":
    folder_path = "/Users/dvdrnd/Downloads/test_mean_spectrogram/recordings1"
    output_csv = "average_spectrogram.csv"  # Define the output CSV file name
